...
bool PatternEngine::renderPatternKeeperImportPdf(const QString &pdfPath,
    ...
    pdf.setCreator("SpriteStitchCPP v" APP_VERSION);
...
bool PatternEngine::renderPdf(const QString &pdfPath,
    ...
    auto drawHeader = [&](const QString &subtitle) {
        ...
        QString layout = QString("PDF layout: grid %1 | legend %2 | page %3 | center lines %4 | symbols %5 | v2.9.5")
                .arg(gridSizeName())
    ...
    auto drawCoverPage = [&]() {
        ...
        p.drawText(QRect(margin, margin + 165, pageW - margin * 2, 45), Qt::AlignLeft | Qt::AlignVCenter,
                   QStringLiteral("Cross-stitch pattern generated by SpriteStitch C++ v2.9.5"));
...
PatternResult PatternEngine::generatePdf(const QString &imagePath, const PatternOptions &options) {
    ...
    const QString pdfPath = uniqueFilePath(outDir, base + "_cross_stitch_v2_9_5", ".pdf");
    const QString csvPath = uniqueFilePath(outDir, base + "_legend_v2_9_5", ".csv");
    const QString pkPdfPath = uniqueFilePath(outDir, base + "_pattern_keeper_import_v2_9_5", ".pdf");
    const QString previewPngPath = uniqueFilePath(outDir, base + "_website_preview_v2_9_5", ".png");
