...
bool PatternEngine::renderPdf(const QString &pdfPath,
    ...
    auto drawHeader = [&](const QString &subtitle) {
        ...
        QString layout = QString("PDF layout: grid %1 | legend %2 | page %3 | center lines %4 | symbols %5 | v2.9.6")
                .arg(gridSizeName())
    ...
    auto drawCoverPage = [&]() {
        ...
        p.drawText(QRect(margin, margin + 165, pageW - margin * 2, 45), Qt::AlignLeft | Qt::AlignVCenter,
                   QStringLiteral("Cross-stitch pattern generated by SpriteStitcher v2.9.6"));
